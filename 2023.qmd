...
These are the maps I created for the [\#30DayMapChallenge](https://30daymapchallenge.com/)  2023.

This was the first time I participated in the \#30DayMapChallenge. This time I had successfully created all 30 maps.
The majority of the maps are made using R and its `tidyverse` ecosystem, and codes can be found at [my GitHub repository](https://github.com/sokimura39/30DayMapChallenge).
